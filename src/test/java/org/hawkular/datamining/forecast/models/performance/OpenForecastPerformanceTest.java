...
public class OpenForecastPerformanceTest extends AbstractPerformanceTest {
    ...
    public void testPerformance() {
        ...
        Function<DataSet, ForecastingModel> _SimpleExponentialSmoothingModel = new Function<DataSet, ForecastingModel>() {
            @Override
            public ForecastingModel apply(DataSet input) {
                return SimpleExponentialSmoothingModel.getBestFitModel(input);
            }
        };
        
        Function<DataSet, ForecastingModel> _DoubleExponentialSmoothingModel = new Function<DataSet, ForecastingModel>() {
            @Override
            public ForecastingModel apply(DataSet input) {
                return DoubleExponentialSmoothingModel.getBestFitModel(input);
            }
        };
        
        Function<DataSet, ForecastingModel> _TripleExponentialSmoothingModel = new Function<DataSet, ForecastingModel>() {
            @Override
            public ForecastingModel apply(DataSet input) {
                return TripleExponentialSmoothingModel.getBestFitModel(input);
            }
        };
        
        testCaseAverageExecutionTime(5, dataSetSineMediumLength, _SimpleExponentialSmoothingModel,
                SimpleExponentialSmoothingModel.class.getName());
        testCaseAverageExecutionTime(5, dataSetSineMediumLength, _DoubleExponentialSmoothingModel,
                DoubleExponentialSmoothingModel.class.getName());
        testCaseAverageExecutionTime(5, dataSetSineMediumLength, _TripleExponentialSmoothingModel,
