...
//            rModel = ModelReader.read("austourists");
    ...
    public void performanceTest() throws IOException {
        ...
        testCase(numberOfExecutions, rModel, new Function<ModelData, Long>() {
            @Override
            public Long apply(ModelData input) {
                return executeSimplex(input);
            }
        }, "Simplex");
        ...
        testCase(numberOfExecutions, rModel, new Function<ModelData, Long>() {
            ...
            @Override
            public Long apply(ModelData input) {
                return executeMultidirectionalSimplex(input);
            }
