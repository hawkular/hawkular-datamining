...
public class SeasonalDecomposition {
    ...
    public SeasonalDecomposition(List<DataPoint> points, int periods) {
    ...
    public List<DataPoint> getSeasonal() {
    ...
    public List<DataPoint> getRandom() {
        if (random == null && seasonalIndices != null) {
            List<DataPoint> seasonal = getSeasonal();
    ...
    public List<DataPoint> getTrend() {
        return trend;
    }
}
